<template>
  <div>
    <n-card title="" style="align-items: self-start">
      <n-space>
        <n-auto-complete v-model:value="query_r_name" placeholder="词牌/韵律" clearable />
...
export default defineComponent({
  ...
  methods: {
    random_pick: function () {
      axios
        .get(this.BASE_URL + "/display/rhythmic?" + "items_per_page=" + this.items_per_pag)
        .then((response) => {
